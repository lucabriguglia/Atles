...
public class ForumPageTopicsService : IForumPageTopicsService
{
    private readonly AtlesDbContext _dbContext;

    public ForumPageTopicsService(AtlesDbContext dbContext)
    {
        _dbContext = dbContext;
    }

    public async Task<PaginatedData<ForumPageModel.TopicModel>> GetForumPageTopics(GetForumPageTopics query)
    {
