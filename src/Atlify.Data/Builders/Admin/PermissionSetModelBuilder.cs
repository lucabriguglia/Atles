...
using Atlify.Models.Admin.Roles;
using Atlify.Domain;
using Atlify.Domain.PermissionSets;
using Microsoft.EntityFrameworkCore;
using IndexPageModel = Atlify.Models.Admin.PermissionSets.IndexPageModel;

namespace Atlify.Data.Builders.Admin
{
    public class PermissionSetModelBuilder : IPermissionSetModelBuilder
    {
        ...
        public PermissionSetModelBuilder(AtlifyDbContext dbContext, IRoleModelBuilder roleManager)
        {
